        ...
        rules:[
            {
                ...
                exclude: /(node_modules|bower_components)/, // excluye los archivos que esten en node_modules o bower_components
                use:{
            ...
            {
                test: /\.png/, // le dice que utilice archivos con extension .png, .jpg, .gif, .svg
